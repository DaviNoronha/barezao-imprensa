@if (Auth::user()->perfil->nome == 'admin')
    ...
    <div class="row">
        ...
        <button type="button" class="ml-2 btn btn-sm btn-default" data-toggle="modal" data-target="#modal-default"><i class="ni ni-user-run"></i> Jogadores</button>
    </div>
    @elseif ($tipo == 'user')
    <div class="row">
...
@else
    @if ($tipo == 'time')
        <button type="button" class="btn btn-sm btn-default" data-toggle="modal" data-target="#modal-default"><i class="ni ni-user-run"></i> Jogadores</button>
    @endif
@endif
